 ...
 * goes straight to the business's subaccount. `bearer: 'subaccount'` means
 * the business absorbs Paystack's own processing fee, not the platform.
 */
export async function initializeTransaction(params: {
  ...
  if (params.subaccount) {
    ...
    body.bearer = 'subaccount'; // business owner bears the Paystack processing fee
